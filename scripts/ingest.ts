 ...
 * See the UK implementation (uk-farm-subsidies-mcp) for the reference pattern.
 *
...
console.log('See uk-farm-subsidies-mcp/scripts/ingest.ts for the reference pattern.');
